...
exports.PatientModule = PatientModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([patient_model_1.PatientModel])],
        controllers: [patient_controller_1.PatientController],
        providers: [patient_service_1.PatientService, patient_repository_1.PatientRepository, patient_usecase_1.PatientUseCase],
    })
], PatientModule);
